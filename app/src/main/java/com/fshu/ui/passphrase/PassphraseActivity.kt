package com.fshu.ui.passphrase
...
import com.fshu.MainActivity
import com.fshu.data.remote.WebSocketClient
import com.fshu.databinding.ActivityPassphraseBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        onBackPressedDispatcher.addCallback(this, object : OnBackPressedCallback(true) {
            override fun handleOnBackPressed() {
                ...
                Prefs.setUsername(this@PassphraseActivity, "")
                Prefs.setPassword(this@PassphraseActivity, "")
            ...
            lifecycleScope.launch {
                try {
                    ...
                    val hintDeferred = async {
                        withTimeout(8_000L) {
                            MessageBus.events
                                .filter { it.get("type")?.asString == "passphrase-hint" }
                                .first()
                        }
                    }
        ...
        // Pre-fill hint with whatever is stored locally so the user can see it.
        ...
        binding.btnConfirm.setOnClickListener {
            ...
            if (pass.isEmpty()) {
                Toast.makeText(this, "Enter your passphrase", Toast.LENGTH_SHORT).show()
